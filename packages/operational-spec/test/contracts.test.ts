...
test("defines immutable provider-neutral operational contracts and compiles deterministic IR", () => {
  ...
  const rawSpec = {
    ...
    resources: [{ id: "operational-resource:supplier", kind: "SEMANTIC_OBJECT", reference: "entity:supplier-42" }],
    ...
    projectionRequirements: [{ id: "projection-requirement:workspace", projectionKind: "APP", requirement: "render supplier status and approval state", outcomeContractRefs: [outcome.id] }],
